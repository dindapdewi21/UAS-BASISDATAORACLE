      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end">
		   ...
		   <h3><center>Laporan Penjualan Minimaket Mitra Jaya</center></h3>
			 <br>
                ...
                <div class="card-body">
                 ...
                 <th>JUMLAH_BARANG</th>
                  ...
                  <th>TOTAL_PEMBAYARAN</th>   						
					...
					$no = 1;
					$total_semua = 0;
					$stid = oci_parse($koneksi,'SELECT Kasir.*, Kustomer.*, Transaksi.* FROM Transaksi
          Transaksi INNER JOIN Kasir Kasir ON Transaksi.ID_KASIR= Kasir.ID_KASIR 
          INNER JOIN Kustomer Kustomer ON Transaksi.ID_KUSTOMER = Kustomer.ID_KUSTOMER 
          ORDER BY Transaksi.ID_TRANSAKSI ASC');    
            ...
            <td>
             <?php echo rupiah ($row["HARGA_TRANSAKSI"]); ?>
            </td>
            <td>
             <?php echo rupiah ($row["TOTAL_PEMBAYARAN"]); ?>
            </td>
                     </tr>                                         
                    </tbody>
					 <?php
